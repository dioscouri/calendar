...
class JFakeElementCalendarTypes extends JFakeElementBase
{
	var	$_name = 'CalendarTypes';

	public function getInput() 
	{
		return JFakeElementCalendarTypes::fetchElement($this->name, $this->value, $this->element, $this->options['control']);
...
if(version_compare(JVERSION,'1.6.0','ge')) {
	class JFormFieldCalendarTypes extends JFakeElementCalendarTypes {}
} else {
	class JElementCalendarTypes extends JFakeElementCalendarTypes {}
}
