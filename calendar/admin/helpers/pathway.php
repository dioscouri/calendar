...
class CalendarHelperPathway extends CalendarHelperBase 
{
    /**
    ...
    function insertCategories( $items, $item_id='' )
    {
        ...
        foreach ($items as $item)
        {
            $category_itemid = (!empty($item_id)) ? $item_id : Calendar::getClass( "CalendarHelperRoute", 'helpers.route' )->category( $item->id, true );
