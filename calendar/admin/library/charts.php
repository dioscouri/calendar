...
class CalendarCharts extends JObject {
	 ...
	 * @access public
	 * @param mixed $data
	 * @param string $title. (default: 'A Calendar Google Chart')
	 * @param string $type. (default: 'Column')
	 * @param int $width. (default: 900)
	 * @param int $height. (default: 250)
	 * @return void
	 */
	function renderGoogleChart($data, $title='A Calendar Google Chart', $type='Column', $width=800, $height=250)
    {
        $title  = JText::_( $title );
