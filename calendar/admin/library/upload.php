 ...
 *   - update for GD2 (changed imageresized() into imagecopyrecalendard() and imagecreate() into imagecreatetruecolor())</li>
 * </ul>
 *
 * @package   cmf
 * @subpackage external
...
class CalendarUpload extends CalendarImage 
{
    /**
     * Class version
     *
     ...
     */
    function CalendarUpload($file, $lang = 'en_GB') {
            ...
            if ($image_manipulation) {
                ...
                if ($this->processed && $image_src) {
                    ...
                    if ($this->image_resize) {
                        ...
                        if ($gd_version >= 2) {
                            $res = imagecopyrecalendard($tmp, $image_src, 0, 0, 0, 0, $this->image_dst_x, $this->image_dst_y, $this->image_src_x, $this->image_src_y);
                        } else {
                   ...
                   if ($gd_version >= 2 && (is_numeric($this->image_overlay_percent) && $this->image_overlay_percent > 0 && !empty($this->image_overlay_color))) {
                    ...
                    if ($this->image_watermark!='' && file_exists($this->image_watermark)) {
                        ...
                        if ($watermark_checked) {
                            ...
                            imagecopyrecalendard ($image_dst, $filter, $watermark_x, $watermark_y, 0, 0, $watermark_width, $watermark_height, $watermark_width, $watermark_height);
                        } else {
                            $this->error = $this->translate('watermark_invalid');
                        }
                    }
