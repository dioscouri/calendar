...
class CalendarModelElementCalendar extends DSCModelElement
{
    var $title_key = 'calendar_name';
    ...
    public function getTable($name='Calendars', $prefix='CalendarTable', $options = array())
    {
