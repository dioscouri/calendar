...
class CalendarTableNested extends CalendarTable
{
	/**
	 * Extends to add some fields based on calculations
	 * @see calendar/admin/tables/CalendarTable#load($oid, $key)
	 */
	 ...
	 * @see calendar/admin/tables/CalendarTable#move($change, $where)
	 */
