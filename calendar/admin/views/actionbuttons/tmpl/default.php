        ...
        <thead>
            <tr>
                ...
                <th style="text-align: left;">
                    <?php echo CalendarGrid::sort( 'Name', "tbl.name", @$state->direction, @$state->order );
					?>
                </th>
                <th>
        ...
        <?php foreach ( @$items as $item ) : ?>
            <tr class='row<?php echo $k; ?>'>
                ...
                <td style="text-align: center;">
                   	<?php echo CalendarGrid::checkedout( $item, $i, 'actionbutton_id' ); ?>
                </td>
                <td style="text-align: center;">
                    <a href="<?php echo $item->link; ?>">
                        <?php echo $item->actionbutton_id; ?>
                    </a>
                </td>   
                ...
                <td style="text-align: left;">
                    <a href="<?php echo $item->actionbutton_url_default; ?>">
                        <?php echo $item->actionbutton_url_default; ?>
                    </a>
                </td>
            </tr>
            <?php $i = $i + 1;
