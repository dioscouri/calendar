    ...
    <table class="adminlist" style="clear: both;">
        <thead>
            <tr>
                ...
                <th>
                	<?php echo CalendarGrid::sort( 'Date from', "tbl.calendar_filter_date_from", @$state->direction, @$state->order );
					?>
                </th>
                <th>
                	<?php echo CalendarGrid::sort( 'Date to', "tbl.calendar_filter_date_to", @$state->direction, @$state->order );
					?>
                </th>
            </tr>
            <tr class="filterline">
        ...
        <?php foreach ( @$items as $item ) : ?>
            <tr class='row<?php echo $k; ?>'>
                ...
                <td style="text-align: center;">
                   	<?php echo CalendarGrid::checkedout( $item, $i, 'calendar_id' ); ?>
                </td>
                <td style="text-align: center;">
                ...
                <td style="text-align: left;">
                    ...
                    <div><b><?php echo JText::_( "Primary Categories"); ?>:</b> <span class="grey"><?php echo CalendarHelperCategory::getCategoriesNames( $item->calendar_filter_primary_categories ); ?></span></div>
                    <div><b><?php echo JText::_( "Secondary Categories"); ?>:</b> <span class="grey"><?php echo CalendarHelperCategory::getCategoriesNames( $item->calendar_filter_secondary_categories, 'SecondCategories' ); ?></span></div>
                </td>                   
                <td style="text-align: left;">
                    <?php echo $item->calendar_filter_date_from; ?>
                </td>
                <td style="text-align: left;">
                    <?php echo $item->calendar_filter_date_to ; ?>
                </td>
            </tr>
            <?php $i = $i + 1;
				$k = ( 1 - $k );
