...
JHTML::_( 'stylesheet', 'skin.css', 'modules/mod_calendar_eventinstances/css/jcarousel-skins/bgl-medium/' );
...
<div class="slideshow">
    <ul class="horiz features slideshow-content jcarousel-skin-bgl">
        ...
        <li class="slideshow-slide">
            <div class="feature">
                <a href="<?php echo JRoute::_( $row->link_view . "&Itemid=" . $vars->item_id ); ?>">
                    ...
                    <img src="<?php echo $row->image_src; ?>" width="<?php echo $medium_width; ?>" height="<?php echo $medium_height; ?>" /> 
