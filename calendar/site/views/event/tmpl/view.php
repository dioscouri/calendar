...
<div id="calendar-content" class="event-detail detail-page">
    ...
    <div id="date-time-venue-buy" class="table wrap full">
        <div class="cell date-time wrap red">
            ...
            <h2><?php $price_range = $item->show->displayPrices; if (!empty($price_range)) { echo $price_range; } elseif (JDEBUG) { /*echo '{Price range from $item->show->displayPrices}';*/ } ?></h2>
        </div>
        ...
        <div class="cell other-instances wrap">
            <select id="select-instance">
                <?php foreach ($this->instances as $instance) { ?>
                    <option 
                        value="<?php echo $instance->getPurchaseURL(); ?>"
        ...
        <div class="cell buy buttons wrap">
            ...
            <div class="user-actions left clear wrap">
                ...
                <div class="add-to-calendar">
                    <ul class="content-left">
                        ...
                        <li class="description content-left">
                            <?php if (!empty($item->event_description_short)) { ?>
                                <?php echo $item->event_description_short; ?>
                            <?php } ?>
                        </li>                                        
                    </ul>
                </div>
            ...
            <div class="inner">
                <div id="media-item">
                    ...
                    <div class="media-item-download media-item-property">
                        <a href="<?php echo JRoute::_( "&task=downloadMedia&format=raw" ); ?>" onclick="_gaq.push(['_trackEvent', 'Audio', 'Downloaded', '<?php echo $media_item_title; ?>']);" class="h5">
                            Download Song
                        </a>
                    </div>
                    <?php } ?>
        ...
        echo JHtml::_('tabs.panel', JText::_( "Overview" ), 'tab overview' ); ?>
            ...
            <div class="article-default table full">
                ...
                <div class="cell column-right">
                   ...
                   <?php if ((!empty($item->event->event_type) && !empty($item->event->event_type->display_partof)) || count($item->show->series) ) { ?>
                        <div class="section full">
                            <div class="meta-header h4 purple light-purple-bg">
                                part of
                            </div>
