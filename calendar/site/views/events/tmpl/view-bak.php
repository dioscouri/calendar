	...
	<div id="event-info" class="wrap">
		<div class="col-right">
			...
			<?php if( !empty( $this->instance->series_id )){	?>
			    <div><?php echo JText::_( "This is a" ) . " " . $this->instance->series_name . " " . JText::_( "event"); ?><a href="<?php echo JRoute::_( 'index.php?option=com_calendar&view=series&id=' . (int) $this->instance->series_id ); ?>"><?php echo JText::_( "Go to series page" ); ?></a></div>
			<?php } ?>
		            ...
		            <li>
		                <a href="<?php echo JRoute::_( $related_event->link_view ); ?>">
		                    <div class="feature-info">
		                        ...
		                        <p class="date cat <?php echo $related_event->primary_category_class; ?>">
		                    ...
		                    <img src="<?php echo $related_event->image_src; ?>" width="239" height="134" >
