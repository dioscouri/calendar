    ...
    <div id="event-types" class="wrap">
        <ul class="horiz">
            ...
            <?php foreach ( $this->tabbed_types as $type ) { ?>
                ...
                <?php } else { ?>
                    <li class="<?php echo $type->type_name; ?>-view"><a href="<?php echo JRoute::_( "index.php?option=com_calendar&view=month&reset=0&type=" . $type->type_id . $itemid_string ); ?>"><?php echo JText::_( $type->type_name ); ?></a></li>
                <?php } ?>
            <?php } ?>
        </ul>
    </div>
		...
		<?php if ( !empty($this->days) && !empty($this->count) ) { ?>
	        ...
	        <?php endforeach; ?>
                ...
                <?php if ( !empty($this->days) && !empty($this->offsite_count) ) { ?>
                    ...
                    <ol class="events-month wrap offsite">
        	        <?php foreach ( @$this->days as $day ) : ?>
