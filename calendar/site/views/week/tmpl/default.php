...
<div id="calendar-content" class="wrap week-view">
    ...
    <div id="date-navigation" class="wrap right">
        <ul class="controls controls-medium flat">
    		<li class="prev"><a href="<?php echo JRoute::_( 'index.php?option=com_calendar&view=week&date=' . $this->date_navigation->prev . $itemid_string ); ?>"><?php echo JText::_( "Previous" ); ?></a></li>
    		<li class="next"><a href="<?php echo JRoute::_( 'index.php?option=com_calendar&view=week&date=' . $this->date_navigation->next . $itemid_string ); ?>"><?php echo JText::_( "Next" ); ?></a></li>
        </ul>    
    </div>
